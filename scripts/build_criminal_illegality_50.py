...
SUPPLEMENTAL=[
 {'year_roc':115,'exam_name':'115年司法特種考試四等－法警、執達員、監所管理員','subject_zh':'刑法概要','q_no':8,
  'question':'甲在街上閒晃時，巧遇仇人乙。甲立刻趨前朝乙痛毆，實際上甲並不知乙當下早已準備掏槍朝其擊發子彈，甲基於主觀上的不知而傷害乙應評價為下列何者？',
  'A':'打擊錯誤','B':'因果歷程錯誤','C':'偶然防衛','D':'誤想防衛','answer':'C','group':'正當防衛（刑法§23）'},
 {'year_roc':114,'exam_name':'114年司法特種考試四等－法警、執達員、監所管理員','subject_zh':'刑法概要','q_no':9,
  'question':'甲於夜間行走時，看見仇人乙手持棍狀物站在前方，因甲以為乙要襲擊自己，於是隨手撿起路邊的石頭朝乙扔去，造成乙頭破血流；甲事後發現乙手持的只是其剛買的棍狀法國麵包。關於甲之行為，下列何者正確？',
  'A':'屬於容許錯誤','B':'屬於容許構成要件錯誤','C':'屬於反面的容許構成要件錯誤','D':'屬於包攝錯誤','answer':'B','group':'正當防衛（刑法§23）'},
 {'year_roc':112,'exam_name':'112年原住民族特種考試四等－法警','subject_zh':'刑法概要','q_no':8,
  'question':'依刑法第24條有關緊急避難之規定，下列何者錯誤？',
  'A':'得因避免他人自由之緊急危難主張','B':'得因避免他人財產之緊急危難主張','C':'得因避免自己生命之緊急危難主張','D':'得因避免自己名譽之緊急危難主張','answer':'D','group':'緊急避難（刑法§24）'},
 {'year_roc':112,'exam_name':'112年原住民族特種考試四等－法警','subject_zh':'刑法概要','q_no':12,
  'question':'消防員甲於乙之住宅發生火災之際，未徵得隔壁住戶丙之意願，將丙之住宅大門打破，以便進入丙住宅頂樓救火，下列敘述何者正確？',
  'A':'火災係人為災害，不屬於刑法第24條規定之緊急危難','B':'甲屬於公務上或業務上有特別義務之人，其打破丙宅大門之行為，不適用刑法第24條第1項緊急避難之規定','C':'甲打破丙宅大門之行為，如其係為避免他人財產遭受緊急危難時，即無適用刑法第24條緊急避難規定之餘地','D':'甲打破丙宅大門之行為，必須是出於不得已之行為，始有適用刑法第24條緊急避難規定之餘地','answer':'D','group':'緊急避難（刑法§24）'},
 {'year_roc':111,'exam_name':'111年司法特種考試四等－法警、執達員、監所管理員','subject_zh':'刑法概要','q_no':5,
  'question':'甲搭乘捷運，離開捷運站時，發現身後有乙尾隨，甲誤以為乙要行搶，因此在乙靠近甲時，甲反手毆打乙一拳，致乙受傷，事後發現，乙只是路人而已。有關本案的錯誤類型，何者正確？',
  'A':'客體錯誤','B':'打擊錯誤','C':'容許構成要件錯誤','D':'包攝錯誤','answer':'C','group':'正當防衛（刑法§23）'},
 {'year_roc':109,'exam_name':'109年司法特種考試四等－法警、執達員、監所管理員','subject_zh':'刑法概要','q_no':5,
  'question':'幫派份子甲路上遇到仇家乙，便掏槍射擊乙未中，乙為保命開槍反擊，卻誤中路人丙，丙死亡。下列敘述何者正確？',
  'A':'乙對甲射擊，屬正當防衛，故不成立殺人未遂罪','B':'乙對甲射擊，屬禁止錯誤，減輕其刑','C':'乙對甲射擊，屬禁止錯誤，不成立犯罪','D':'乙誤射丙，係屬客體錯誤','answer':'A','group':'正當防衛（刑法§23）'},
 {'year_roc':108,'exam_name':'108年司法特種考試四等－法警、執達員、監所管理員','subject_zh':'刑法概要','q_no':6,
  'question':'甲某日行經公園，見一名中年男子乙在追逐女子丙，心想英雄救美，於是上前將乙打倒在地，致乙受有輕傷，事後方知兩人是在比賽跑步，甲毆打乙之行為如何評價？',
  'A':'甲是正當防衛','B':'甲是緊急避難','C':'甲是偶然防衛','D':'甲是誤想防衛','answer':'D','group':'正當防衛（刑法§23）'},
 {'year_roc':114,'exam_name':'114年一般警察特種考試四等－行政警察人員','subject_zh':'刑法概要','q_no':5,
  'question':'警察甲持搜索票對乙宅進行搜索，乙拒不開門，甲強行進入乙宅進行搜索，下列何者正確？',
  'A':'甲可主張正當防衛而阻卻違法','B':'乙可主張正當防衛而阻卻違法','C':'甲可主張依法令之行為而阻卻違法','D':'乙可主張依法令之行為而阻卻違法','answer':'C','group':'依法令／業務正當行為（刑法§21～22）'},
 ...
 {'year_roc':115,'exam_name':'115年一般警察人員四等－行政警察人員','subject_zh':'刑法概要','q_no':1,
  'question':'依刑法三階層犯罪理論，下列何者非屬犯罪成立要件？','A':'罪責','B':'違法性','C':'訴訟條件','D':'構成要件該當性','answer':'C','group':'違法性體系／邊界辨識'},
 {'year_roc':108,'exam_name':'108年一般警察人員四等－行政警察人員','subject_zh':'刑法概要','q_no':3,
  'question':'依我國刑法之相關規定，下列何種行為仍應予處罰？','A':'行為時因精神障礙致不能辨識其行為違法者','B':'因故意或過失招致行為時欠缺辨識能力者','C':'因避免自己生命之緊急危難而出於不得已之行為，且無避難過當者','D':'未滿14歲之瘖啞人','answer':'B','group':'違法性體系／邊界辨識'},
 {'year_roc':111,'exam_name':'111年司法人員特考－執達員','subject_zh':'刑法概要','q_no':18,
  'question':'有關刑法之原因自由行為，下列敘述何者錯誤？','A':'所謂原因自由行為，係指行為人因故意或過失招致無責任能力或限制責任能力狀態，進而實行犯罪構成要件之行為','B':'甲為殺乙，先喝酒壯膽，自陷無責任能力狀態而殺害乙，不得因無責任能力而不罰','C':'原因自由行為並非法定阻卻違法事由','D':'目前並無對於原因自由行為處罰之明文規定，因此對原因自由行為之處罰，違反罪刑法定原則','answer':'D','group':'違法性體系／邊界辨識'},
 {'year_roc':115,'exam_name':'115年司法官／律師第一試','subject_zh':'綜合法學（一）（刑法、刑事訴訟法、法律倫理）','q_no':3,
  'question':'依實務見解，關於不法意識之理解，下列敘述何者錯誤？','A':'不法意識係指行為人對於禁止規範有認識與理解，並採取敵對或漠視之態度','B':'不法意識屬故意的一部分，若欠缺不法意識即無構成要件故意','C':'只要知其行為乃法所不許，即可認定有不法意識，不需要精確認識違反那一條特定法規','D':'法律頒布後，行為人即有類如民法上之善良管理人之注意義務，而不可擅為主張不知','answer':'B','group':'違法性體系／邊界辨識'}
]
...
def basis_note(r,g):
    z=target_text(r)
    if g.startswith('違法性體系'):
        return '刑法犯罪論三階層／違法性與罪責區分','本題用來辨識違法性在犯罪論體系中的位置，並與責任能力、不法意識等罪責問題區分；正解依原考試年度官方答案。'
